...
/*============== INTRODUCCION DE DATOS DE PRUEBA CITAS ==============*/
/*CITAS*/

INSERT INTO CITAS(TIPO,DESCRIPCION,SEÑAL,PRECIO,ESTADO,TATUADOR,ANILLADOR,CABINA) VALUES ('TATUAJE','Primera cita de prueba',20.0,120.0,'RESERVADA',1,NULL,1);
INSERT INTO CITAS(TIPO,DESCRIPCION,SEÑAL,PRECIO,ESTADO,TATUADOR,ANILLADOR,CABINA) VALUES ('TATUAJE','Tatuaje en cabina 2',20.0,120.0,'REALIZADA',5,NULL,2);
INSERT INTO CITAS(TIPO,DESCRIPCION,SEÑAL,PRECIO,ESTADO,TATUADOR,ANILLADOR,CABINA) VALUES ('PIERCING','Cita de piercing de prueba',20.0,120.0,'RESERVADA',NULL,2,1);
INSERT INTO CITAS(TIPO,DESCRIPCION,SEÑAL,PRECIO,ESTADO,TATUADOR,ANILLADOR,CABINA) VALUES ('PIERCING','Piercing en cabina 4',20.0,120.0,'REALIZADA',NULL,4,4);

CALL CREAR_HUECOS_SEMANALES('2025-1-20',2);
UPDATE HUECOS SET CITA = 1 WHERE NUMERO = 1 AND CABINA = 1 ;
UPDATE HUECOS SET CITA = 1 WHERE NUMERO = 2 AND CABINA = 1 ;
UPDATE HUECOS SET CITA = 2 WHERE NUMERO = 1 AND CABINA = 2 ;
UPDATE HUECOS SET CITA = 2 WHERE NUMERO = 2 AND CABINA = 2 ;
UPDATE HUECOS SET CITA = 3 WHERE NUMERO = 10 AND CABINA = 1 ;
UPDATE HUECOS SET CITA = 3 WHERE NUMERO = 11 AND CABINA = 1 ;
UPDATE HUECOS SET CITA = 4 WHERE NUMERO = 10 AND CABINA = 4 ;
UPDATE HUECOS SET CITA = 4 WHERE NUMERO = 11 AND CABINA = 4 ;